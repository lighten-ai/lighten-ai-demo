...
export interface TherapeuticAreaRow {
  id: string;
  name: string;
  lastModified: string;
  lastRefresh: string;
...
export const suggestedTAs: TherapeuticArea[] = [
  {
    ...
    name: "Cardiology",
    description:
      "RW evidence provides an end-state view of the treatment landscape in cardiac therapeutic categories for informed strategic decisions.",
    confidence: "High",
    scores: {
      longitudinality: 28,
  ...
  },
  {
    ...
    name: "Oncology",
    description:
      "Analyze the latest advancements in cancer treatment landscapes for informed strategic decisions.",
    confidence: "High",
    scores: {
      longitudinality: 26,
...
export const therapeuticAreaRows: TherapeuticAreaRow[] = [
  {
    id: "1",
